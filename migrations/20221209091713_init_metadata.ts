...
export async function up(knex: Knex) {
	await knex.schema.createTable('account', (table: any) => {
		...
		table
			.enum('account_type', [AccountType.ADMIN, AccountType.AUTHORIZED])
			.defaultTo(AccountType.AUTHORIZED)
			.notNullable();
		table
			.enum('account_status', [AccountStatus.ACTIVATED, AccountStatus.WAITING])
			.defaultTo(AccountStatus.WAITING)
			.notNullable();
	...
	await knex.schema.createTable('project', (table: any) => {
		...
		table
			...
			.defaultTo(ProjectStatus.SUBMITTED)
			.notNullable();
		table
			.enum('active_status', [ProjectActiveStatus.COMING_SOON, ProjectActiveStatus.RELEASED])
			.defaultTo(ProjectActiveStatus.COMING_SOON)
			.notNullable();
